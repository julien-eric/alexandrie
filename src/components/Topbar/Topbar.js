...
export const Topbar = ({
  ...
  return (
    <Navbar bg='light' expand='lg' className='alx sticky-top'>
      ...
      <Navbar.Brand href='#home2'>ALEXANDRIE</Navbar.Brand>
      <Form className='ms-5 col-7'>
        <InputGroup className='col-8'>
          <InputGroup.Text><i className='fas fa-search' /></InputGroup.Text>
          <FormControl id='alx-nav-search' size='lg' type='text' placeholder={t('menus:headings.search-pps')} className='mr-sm-2' />
        </InputGroup>
      </Form>
    </Navbar>)
}
